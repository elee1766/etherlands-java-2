...
import etherlandscore.etherlandscore.services.LocaleServices;
...
public final class EtherlandsCore extends JavaPlugin {
  ...
  public void onEnable() {
    ...
    Fiber localeServiceFiber = new ThreadFiber();
    LocaleServices localeServices = new LocaleServices(channels, localeServiceFiber);
    modules.add(localeServices);
    localeServices.start();
